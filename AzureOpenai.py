...
i=0
while True:
    audio_config = speechsdk.audio.AudioOutputConfig(use_default_speaker=True, filename="./voice/file"+str(i)+".wav")
    speech_config.speech_synthesis_voice_name='zh-TW-HsiaoYuNeural'#zh-TW-HsiaoYuNeural #en-US-AshleyNeural
